  ...
  return (
    <div className="w-screen ">
      <div className="mx-auto flex max-w-[50rem] flex-col items-center space-y-[18px] pt-[18vh]">
        <p className="max-w-[50rem] bg-gradient-to-b from-header-100 to-header-200 bg-clip-text text-center font-display text-[3.5rem] font-bold text-transparent">
          A violence encounter tool for capturing unsafe situations
        </p>
        <p className="max-w-[34rem] text-center font-display font-medium text-header-300 text-opacity-60">
