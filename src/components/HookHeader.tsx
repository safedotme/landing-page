  ...
  return (
    <div className="w-screen ">
      <div className="mx-auto flex  flex-col items-center space-y-[18px] pt-[18vh]">
        <p className="xlg:text-[3.5rem] bg-gradient-to-b from-header-100 to-header-200 bg-clip-text text-center font-display font-[800] leading-tight text-transparent sm:mx-[20px] sm:max-w-[500px] sm:text-[1.55rem] md:mx-0 md:max-w-[700px] md:text-[2.5rem] lg:max-w-[800px] lg:text-[3rem]">
